...
- **Deploy produção (17/05/2026 BRT, mais recente):** commit **`6085853`** (HEAD `main`), **`dpl_DTf6cFjrQLpFyVYYs8gur13U8HV9`** (READY), URL `https://febracis-6qg6yr8x6-deivithis-projects.vercel.app`, inspect [`https://vercel.com/deivithis-projects/febracis-dre/DTf6cFjrQLpFyVYYs8gur13U8HV9`](https://vercel.com/deivithis-projects/febracis-dre/DTf6cFjrQLpFyVYYs8gur13U8HV9), alias [`https://febracis-dre.vercel.app`](https://febracis-dre.vercel.app) — PRD **2.2-agent7** (voz CIS inspirada na linha institucional de Paulo Vieira **sem personificação**; bordões *Yes.* / *caraca* positiva rara; `PROMPT_INSTITUCIONAL_FEBRACIS_LINES` + prompts API/`ASSISTANT_FALLBACK_COPY_VARIANTS`; build remoto sem `error TS`).
