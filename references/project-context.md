...
Última revisão documental: 08/05/2026 BRT — Sem duplicação UI: bloque **Preenchimento da grelha** apenas na faixa KPI (`SubmissionKpiSection`); coluna “Resumo” do rail já não repete esse bloco. Deploy `dpl_5HoGgcfE4Co9c4js58vdsU7EZ1ZH`. Validar sempre contra Vercel/GitHub/Supabase antes de mudar papéis, RLS ou deploy.
